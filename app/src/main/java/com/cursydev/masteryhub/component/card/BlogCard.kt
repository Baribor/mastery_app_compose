...
@Composable
fun BlogCard(blogData: BlogData, onClick: (blogData: BlogData)->Unit = {}) {
    ...
    Card(modifier = Modifier.padding(8.dp).clickable {
        ...
        Column(modifier = Modifier.fillMaxWidth().padding(8.dp, 0.dp)) {
            ...
            Text(text = blogData.desc, style = MaterialTheme.typography.bodySmall, maxLines = 4, overflow = TextOverflow.Ellipsis)
...
fun BlogCardPrev() {
    ...
    val data = BlogData(
        mTitle = "Nigeria Federal Government earmarks N15bn for Safe Schools Initiative and some long unnecessary texts go here",
